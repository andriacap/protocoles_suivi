...
AS WITH source AS (
 ...
 SELECT 
    ...
    nullif(json_extract_path(oc.data::json,'id_nomenclature_etat_bio')::text,'null')::integer AS id_nomenclature_etat_bio,
    ...
    json_build_object(
        ...
        'owner_site',json_extract_path(sc.data::json,'owner')::text, 
        'proprietepzh',json_extract_path(sc.data::json,'proprietepzh')::text, 
        'id_nomenclature_type_site', ref_nomenclatures.get_nomenclature_label(nullif(json_extract_path(sc.data::json,'id_nomenclature_type_site')::text,'null')::integer, 'fr'),
        'id_nomenclature_prospection', ref_nomenclatures.get_nomenclature_label(nullif(json_extract_path(sc.data::json,'id_nomenclature_prospection')::text,'null')::integer, 'fr'),
        'passage', json_extract_path(vc.data::json,'passage')::text, 
    	'periode', json_extract_path(vc.data::json,'periode')::text, 
      'tempAir', json_extract_path(vc.data::json,'tempAir')::text, 
      'humidite', json_extract_path(vc.data::json,'humidite')::text, 
      'pluviosite', json_extract_path(vc.data::json,'pluviosite')::text, 
      'couvertureNuageuse', json_extract_path(vc.data::json,'couvertureNuageuse')::text,
      'vent', json_extract_path(vc.data::json,'vent')::text,  
      'pertubations', json_extract_path(vc.data::json,'pertubations')::text,  
      'comment_visit', json_extract_path(vc.data::json,'comment_visit')::text,
      'etat_bio', ref_nomenclatures.get_nomenclature_label(nullif(json_extract_path(oc.data::json,'id_nomenclature_etat_bio')::text,'null')::integer, 'fr'),
      'stade_de_vie', ref_nomenclatures.get_nomenclature_label(nullif(json_extract_path(oc.data::json,'id_nomenclature_stade')::text,'null')::integer, 'fr'),
  'sexe_majoritaire', ref_nomenclatures.get_nomenclature_label(nullif(json_extract_path(oc.data::json,'id_nomenclature_sex')::text,'null')::integer, 'fr'),
  'comportement', json_extract_path(oc.data::json,'comportement')::text,
   'count_tranche', json_extract_path(oc.data::json,'count_tranche')::text,
   'count_exact', json_extract_path(oc.data::json,'count_exact')::text,
   'count_average', json_extract_path(oc.data::json,'count_average')::text,
  'comment_obs', json_extract_path(oc.data::json,'comments')::text
  ) as additional_data
